...
COPY receiver_new_thread_pool.py .

# Copy your trained YOLOv11 model into the container's working directory.
# This assumes 'yolov11best.pt' is in the same directory as your CameraDockerFile_new_save_all.dockerfile on your host machine.
COPY yolov11best.pt .
...
CMD ["python", "receiver_new_thread_pool.py"]
