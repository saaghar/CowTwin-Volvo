...
def run_inference_on_image(image_path, predictor, cfg, verbose, threshold=0.6, output_path="result.jpg", nms_threshold=0.5):
    """
    ...
    if len(filtered_instances) > 0:
        ...
        keep = batched_nms(boxes, scores, classes, nms_threshold)
...
def main(args):
    ...
    if os.path.isdir(args.image_path):
        ...
        for i, image_path in enumerate(tqdm(image_files, desc="Processing images")):
            ...
            try:
                ...
                results[img_name] = run_inference_on_image(
                    image_path, 
                    predictor, 
                    cfg, 
                    verbose,
    ...
    # Run inference on a single image
        ...
        output_path = os.path.join(args.output_path, "result.png")
        ...
        outputs = run_inference_on_image(
            args.image_path,
            predictor,
            cfg,
            verbose,
